...
// A rename from Hub › Modules on / off overrides these (see below).
...
/** Signing rules — the Projects door's second tab (D1). The gate is the door's. */
export async function SigningRulesBody() {
  ...
  // A rename done on Modules on / off wins; otherwise use the curated heading
  // above, otherwise the registry default. One source of truth.
