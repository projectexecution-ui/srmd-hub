...
/**
 * Manual fallback — the Data door's second tab (E1), and still its own page at
 * /admin/manual-upload for the people granted it under People › Powers.
 * Aksha, 10 Sep 2026: "if the live IN4 auto-read fails, I can just switch the
 * toggle on and upload all required sheets in one place." Off: nothing here
 * but the switch and the last-run stamps. On: the three uploads the hub still
 * has a home for — Budget (BPH), contractor certificates, supplier payments —
 * and the IN4 feeds stop writing meanwhile.
 */
export async function ManualFallbackBody() {
  ...
  return (
    <div className="space-y-4">
      ...
      <section className="rounded-2xl border border-gray-200 bg-white p-4">
        ...
        <p className="text-[12px] text-gray-500 mt-2">Indents and WO / PO are read live from IN4 on every page and have no upload. Details and run history: <Link href="/admin/data?tab=in4" className="text-indigo-700 hover:underline">IN4 live sync</Link>.</p>
      </section>
