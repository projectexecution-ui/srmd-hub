...
/**
 * IN4 live sync — the Data door's first tab (E1). Every IN4 feed on one
 * screen: is IN4 connected, when did each feed last run, how close is it to
 * the Excel it replaces, and the switch that makes the sync the source instead
 * of the upload. Below it, the one mapping the budget feed needs — which IN4
 * sub-project is which Budget-Hub project. The gate is the door's.
 */
export async function In4Body() {
