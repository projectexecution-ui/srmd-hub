...
// Embed the original SRMD Indent → PO Tracker HTML verbatim.
// Served from /public/indent-tracker.html. No auth, no anon sign-ins —
// it's an offline-mode tracker that reads/writes locally via Excel upload.
    ...
    <div className="flex flex-col h-screen">
      <div className="flex items-center justify-between px-4 py-2 border-b border-gray-200 bg-white flex-shrink-0">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-semibold text-gray-900">Indent → PO Tracker</span>
        </div>
        <a
          href={SRC}
          target="_blank"
