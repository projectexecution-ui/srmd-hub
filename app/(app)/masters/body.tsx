 ...
 *  Rendered by /masters and by Admin › Data › Masters (E1). */
export async function MastersBody() {
      ...
      <section className="rounded-xl border border-gray-200 bg-white p-4">
        ...
        <div className="mt-2 grid grid-cols-1 md:grid-cols-3 gap-3 text-[13px]">
          {[
            ...
            { who: 'Admins & accounts', links: [['Housekeeping — everything to fix, with where', '/masters/housekeeping'], ['Name mapping — what IN4 calls our projects', '/masters/mapping'], ['Work categories — the hub’s own list, and IN4’s against it', '/cost-control/admin/disciplines'], ['Stores — IN4’s against the Warehouse’s', '/masters/stores']] },
          ].map(g => (
            <div key={g.who}>
