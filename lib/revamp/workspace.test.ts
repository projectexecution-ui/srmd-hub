...
describe('the ribbon is fourteen tabs in five groups', () => {
  it('has exactly fourteen', () => {
    expect(WORKSPACE_TABS).toHaveLength(14)   // +Bills Approval, 14 Sep 2026
  })
