-- Add the whole-project ERP budget to the approval EMAIL payload (management's
-- base figure, shown on top — mirrors the Telegram card + approvals page).
-- Only the cost-control block changes; every other module's approval email is
-- unchanged. Supersedes 20260819_cc_approval_email_identity.sql.
